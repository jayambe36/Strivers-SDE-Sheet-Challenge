#include <bits/stdc++.h>    
using ll = long long int ;    // Declaring long long int data type

pair<int,int> missingAndRepeating(vector<int> &arr, int n)    // Defining function "missingAndRepeating"
{
	ll N = n ;    // Initializing N with value of n

	ll totalSum = (N * (N + 1) ) / 2 ;  ll currSum = 0 ;    // Calculate sum of first n natural numbers

	ll totalSqSum = (N * (N + 1) * (2 * N + 1) ) / 6 ;  ll currSqSum = 0 ;    // Calculate sum of squares of first n natural numbers
