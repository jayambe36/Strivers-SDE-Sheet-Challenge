#include <bits/stdc++.h> 
using ll = long long int ;    // Initialize a long long variable ll
ll ans = 0 ;    // Initialize a long long variable ans

vector<ll> merge(vector<ll> &A , vector<ll> &B)    // Define a function merge
{
    vector<ll> merged ;
...
vector<ll> mergeSort(int low , int high , vector<ll> &nums)    // Define a function mergeSort
{
    if(low > high)   return {} ;
...
long long getInversions(long long arr[] , int n)    // Define a function getInversions
{
    vector<ll> nums ;
